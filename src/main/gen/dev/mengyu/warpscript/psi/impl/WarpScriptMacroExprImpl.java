...
public class WarpScriptMacroExprImpl extends ASTWrapperPsiElement implements WarpScriptMacroExpr {

  public WarpScriptMacroExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public WarpScriptProcExpr getProcExpr() {
    return findChildByClass(WarpScriptProcExpr.class);
  }
